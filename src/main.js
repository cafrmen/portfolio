...
const soundArtist = (e) => {
    ...
    boxes.forEach(box => {
        box.style.setProperty('background-image', 'url("portfolio/media/artist.png")');
...
const granulator = (e) => {
    ...
    boxes.forEach(box => {
        box.style.setProperty('background-image', 'url("cafrmen.github.io/portfolio/media/granular.png")');
        box.style.setProperty('background-size', '233%');
